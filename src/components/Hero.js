    ...
    >
      <Container className="pt-[20px] desk:pt-8 pb-10 desk:pb-6 desk:flex-1 desk:flex desk:flex-col desk:justify-start">
        <div className="grid grid-cols-12 gap-x-4 md:gap-x-8 gap-y-8 md:gap-y-12 items-start">
          ...
          <div className="col-span-12 desk:col-span-7 desk:col-start-6 relative aspect-[3/2] max-[767px]:aspect-square desk:aspect-square desk:w-[min(100%,calc(100svh-11rem))] desk:justify-self-end overflow-hidden">
